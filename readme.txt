...
= Do I need a doBoard account? =

Yes, to run the widget, you need a doBoard account. doBoard is the task management system that serves as the backend for Spotfix.

= Where can I get the Spotfix code? =

Instructions to obtain the code are available at doboard.com/spotfix#doboard_settings.
...
= 1.0.0 =
* Initial release
* Settings page with code configuration
* Status checking functionality
* Visibility controls for widget display
* Integration with doBoard Spotfix service

== Upgrade Notice ==

= 1.0.0 =
Initial release of Spotfix WordPress plugin.
